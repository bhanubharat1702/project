...
<div id="wrapper">
	...
	<div id="main-menu">
		<ul>
			...
			<li><a href="medicalapprove.jsp" id="main-menu4" accesskey="4" title=""> Medical </a></li>
			<li><a href="ltcapprove.jsp" id="main-menu5" accesskey="5" title="">Ltc</a></li>
		<li><a href="adminhomepage.jsp" id="main-menu5" accesskey="5" title="">BACK</a></li>
		</ul>
	</div>
	<div id="content">
		<div id="left">
