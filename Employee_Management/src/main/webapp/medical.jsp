		...
		<div id="right">
			...
			<form id="form1" name="form1" method="post" action="">
			  <table width="95%">
                <tr>
                  <td>Employee Id</td>
                  <td><input type="text" name="textfield5" id="textfield2" value="<?php $eid=$_COOKIE['eid']; echo $eid; ?>" /></td>
                  <td width="21%" rowspan="6"><div align="center"></div></td>
<tr>
<td>Employee Name</td>
<td><input type="text" name="textfield5" name="textfield2" value="<?php $en=$_COOKIE['name']; echo $en; ?>&nbsp;"/></td></tr>

                <tr>
                  <td width="26%">ReqID</td>
                  <td width="53%"><label>
                  <input type="text" name="textfield4" id="textfield4" value="<?php 
...
echo $cnt;
		  ...
		  ?>" />
                ...
                <tr>
                  ...
                  <td><input type="text" name="textfield3" value="<?php $e=$_COOKIE['email']; echo $e; ?>" /></td>
                </tr>
                <tr>
                  <td>Billphoto</td>
                  <td><span class="style6">
